...
function ResetPasswordForm() {
  ...
  function validate(): boolean {
    ...
    if (!token) next.form = "This link is invalid or incomplete. Request a new reset link.";
  ...
  if (done) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-2xl dark:border-slate-800 dark:bg-slate-900">
        ...
        <h2 className="mt-4 text-lg font-semibold text-slate-900 dark:text-slate-100">Password updated</h2>
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
      <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Set a new password</h2>
