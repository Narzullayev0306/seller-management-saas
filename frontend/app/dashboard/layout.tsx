...
function NavLink({
  ...
  return (
    <Link
      ...
      className={`group relative flex items-center gap-3 rounded-xl text-xs font-semibold transition-all duration-150 active:scale-[0.97] ${
    ...
    >
      <span className={active ? "text-white" : "text-slate-400 transition-colors group-hover:text-slate-600 dark:text-slate-500 dark:group-hover:text-slate-300"}>
        <Icon d={item.icon} />
      </span>
